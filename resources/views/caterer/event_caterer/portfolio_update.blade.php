        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr />
                    <form class="form-material m-t-40" method="post" action="{{url('caterer/event-caterer/portfolio/update', ['id' => $model->id])}}" enctype="multipart/form-data" onkeypress="return event.keyCode != 13;">
                        @csrf
                        
                        @component('caterer.event_caterer.components.menu_input', ['text' => 'Title', 'field' => 'title', 'model' => $model, 'errors' => $errors])@endcomponent
