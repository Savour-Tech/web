            ...
            <div class="card">
                <div class="card-body pb-0">
                    <div class="d-flex no-block">
                        ...
                        <div class="ml-auto">
                            <a href="{{url('caterer/event-caterer/menu/create')}}">
                    ...
                    <div class="table-responsive m-t-20">
                        <table class="table vm no-th-brd g-data-table">
                            ...
                            <tbody>
                                @foreach($event_caterer->menus as $menu)
                                    <tr>
                                        <td>{{$menu->name}}</td>
                                        ...
                                        <td>
                                            <a href="{{ url('caterer/event-caterer/menu/update/'.$menu->id) }}" class="p-1">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="{{ url('caterer/event-caterer/menu/delete/'.$menu->id) }}" class="p-1 action-confirm">
