...
<div class="container-fluid">
    ...
    <div class="row m-t-40">
        <div class="col-md-12">
            <div class="d-flex no-block">
                ...
                <div class="ml-auto">
                    <br />
                    <a href="{{url('caterer/chef/portfolio/create')}}">
    ...
    <div class="card-columns el-element-overlay">
        ...
        @foreach($chef->portfolios as $item)
                ...
                <div class="el-card-item">
                    <div class="el-card-avatar el-overlay-1">
                        ...
                        <div class="el-overlay">
                            <ul class="el-info">
                                <li>
                                    <a class="btn default btn-outline" href="{{ url('caterer/chef/portfolio/update', ['id' => $item->id]) }}">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                </li>
                                <li>
                                    <a class="btn default btn-outline action-confirm" href="{{ url('caterer/chef/portfolio/delete', ['id' => $item->id]) }}">
